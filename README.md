...
3D Buddy rendering and animation

GLB / glTF

3D Buddy model format

AI / pet-ai.js

Personalized Buddy responses

🏗️ Architecture

The architecture is divided into three conceptual layers:

Application Layer — the website or workflow Buddy is embedded into.

Buddy Layer — the interactive AI and 3D companion.

Infrastructure Layer — database, payment, and backend services.
...
Returning the verified payment result
...
Configure the required SQL tables.

Configure the database according to the backend.

Add your Supabase environment variables.

Deploy the application.

Test registration and database operations.
...
Create another Freshers design
...
Change Razorpay account

Razorpay environment variables

Change Supabase account
